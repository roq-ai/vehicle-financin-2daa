  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Vehicle Financing Application, your reliable partner in the journey towards owning your dream vehicle. Simplifying and accelerating your vehicle financing process."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1541348263662-e068662d82af?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHx2ZWhpY2xlfGVufDB8fHx8MTY5ODc1NzM0N3ww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@rpnickson?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Roberto Nickson`}</Link>{' '}
              on{' '}
              <Link
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Vehicle Financing Application, your reliable partner in the journey towards owning your dream vehicle. Simplifying and accelerating your vehicle financing process.`}
            </Text>
            <Box
